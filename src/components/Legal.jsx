...
const privacy = "This application is a front-end-only project. There is no backend server or database. Personal information is not collected, stored, or shared on any server. When you create an account, your username, email, and list of favorited manga are stored in a file in your web browser's storage on your own device. For your safety, please do not use a real-world password that you use for any other service.";
